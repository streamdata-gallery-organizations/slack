...
paths:
  ...
  /conversations.info:
    get:
      ...
      x-api-path-slug: conversationsinfo-get
      parameters:
      - in: query
        name: channel
  ...
  /chat.meMessage:
    post:
      ...
      x-api-path-slug: chatmemessage-post
      parameters:
      - in: formData
        name: channel
  ...
  /dnd.endSnooze:
    post:
      ...
      x-api-path-slug: dndendsnooze-post
      parameters:
      - in: header
        name: token
        description: Authentication token
  ...
  /groups.history:
    get:
      ...
      x-api-path-slug: groupshistory-get
      parameters:
      - in: query
        name: channel
  ...
  /search.messages:
    get:
      ...
      x-api-path-slug: searchmessages-get
      parameters:
      - in: query
        name: count
  ...
  /groups.setTopic:
    post:
      ...
      x-api-path-slug: groupssettopic-post
      parameters:
      - in: formData
        name: channel
  ...
  /reminders.delete:
    post:
      ...
      x-api-path-slug: remindersdelete-post
      parameters:
      - in: formData
        name: reminder
        description: The ID of the reminder
  ...
  /usergroups.disable:
    post:
      ...
      x-api-path-slug: usergroupsdisable-post
      parameters:
      - in: formData
        name: include_count
        description: Include the number of users in the User Group
  ...
  /files.comments.add:
    post:
      ...
      x-api-path-slug: filescommentsadd-post
      parameters:
      - in: formData
        name: comment
  ...
  /mpim.replies:
    get:
      ...
      x-api-path-slug: mpimreplies-get
      parameters:
      - in: query
        name: channel
  ...
  /dialog.open:
    get:
      ...
      x-api-path-slug: dialogopen-get
      parameters:
      - in: query
        name: dialog
  ...
  /dnd.teamInfo:
    get:
      ...
      x-api-path-slug: dndteaminfo-get
      parameters:
      - in: query
        name: token
        description: Authentication token
  ...
  /conversations.invite:
    post:
      ...
      x-api-path-slug: conversationsinvite-post
      parameters:
      - in: formData
        name: channel
  ...
  /groups.setPurpose:
    post:
      ...
      x-api-path-slug: groupssetpurpose-post
      parameters:
      - in: formData
        name: channel
  ...
  /groups.unarchive:
    post:
      ...
      x-api-path-slug: groupsunarchive-post
      parameters:
      - in: formData
        name: channel
  ...
  /chat.postMessage:
    post:
      ...
      x-api-path-slug: chatpostmessage-post
      parameters:
      - in: formData
        name: as_user
  ...
  /users.setActive:
    post:
      ...
      x-api-path-slug: userssetactive-post
      parameters:
      - in: header
        name: token
        description: Authentication token
  ...
  /conversations.archive:
    post:
      ...
      x-api-path-slug: conversationsarchive-post
      parameters:
      - in: formData
        name: channel
  ...
  /team.profile.get:
    get:
      ...
      x-api-path-slug: teamprofileget-get
      parameters:
      - in: query
        name: token
        description: Authentication token
  ...
  /groups.archive:
    post:
      ...
      x-api-path-slug: groupsarchive-post
      parameters:
      - in: formData
        name: channel
  ...
  /conversations.replies:
    get:
      ...
      x-api-path-slug: conversationsreplies-get
      parameters:
      - in: query
        name: channel
  ...
  /stars.remove:
    post:
      ...
      x-api-path-slug: starsremove-post
      parameters:
      - in: formData
        name: channel
